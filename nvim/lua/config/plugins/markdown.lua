return {
	{
		...
		config = function()
			require('render-markdown').setup({
				...
				callout = {
					note = { raw = '[!笔记]', rendered = '󰋽 笔记', highlight = 'DiagnosticInfo' },
					tip = { raw = '[!提示]', rendered = '󰌶 提示', highlight = 'DiagnosticOk' },
					important = { raw = '[!重要]', rendered = '󰅾 重要', highlight = 'DiagnosticHint' },
					warning = { raw = '[!警告]', rendered = '󰀪 警告', highlight = 'DiagnosticWarn' },
					caution = { raw = '[!注意]', rendered = '󰳦 注意', highlight = 'DiagnosticError' },
