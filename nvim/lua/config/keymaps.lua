...
if expand("%:e") == 'sh'
	...
	call append(line(".")+2, "\# 全网网名:wang东明")
	call append(line(".")+3, "\# 微信:Donnyooo")
...
elseif expand("%:e") == 'py'
	...
	if expand("%:e") == 'cpp'
		...
		call append(line(".")+8, "	int _T = 1;")
		call append(line(".")+9, "	//cin >> _T;")
		call append(line(".")+10, "	while (_T--) {")
		call append(line(".")+11, "		solve();")
		call append(line(".")+12, "	}")
		call append(line(".")+13, "	return 0;")
		call append(line(".")+14, "}")
		call append(line(".")+15, "void solve(){")
		call append(line(".")+16, "}")
		endif
		if expand("%:e") == 'c'
