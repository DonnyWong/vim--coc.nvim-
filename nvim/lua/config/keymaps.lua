...
elseif expand("%:e") == 'py'
	...
	if expand("%:e") == 'cpp'
		...
		call append(line(".")+14, "	std::ios::sync_with_stdio(false);")
		call append(line(".")+15, "	cin.tie(0);")
		call append(line(".")+16, "	cout.tie(0);")
		call append(line(".")+17, "")
		call append(line(".")+18, "	solve();")
		call append(line(".")+19, "")
		call append(line(".")+20, "	return 0;")
		call append(line(".")+21, "}")
		call append(line(".")+22, "")
		call append(line(".")+23, "void solve(){")
		call append(line(".")+24, "}")
