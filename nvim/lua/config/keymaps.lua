...
elseif expand("%:e") == 'py'
	...
	if expand("%:e") == 'cpp'
		...
		call append(line(".")+8, "#define int long long")
		call append(line(".")+9, "using std::cin;")
		call append(line(".")+10, "using std::cout;")
		call append(line(".")+11, "using std::vector;")
		call append(line(".")+12, "const int MAXN = 1e5 + 10;")
		call append(line(".")+13, "")
		call append(line(".")+14, "void solve();")
		call append(line(".")+15, "signed main() {")
		call append(line(".")+16, "	std::ios::sync_with_stdio(false);")
		call append(line(".")+17, "	cin.tie(0);")
		call append(line(".")+18, "	cout.tie(0);")
		call append(line(".")+19, "")
		call append(line(".")+20, "	int _T = 1;")
		call append(line(".")+21, "	/*cin >> _T;*/")
		call append(line(".")+22, "	while (_T--) {")
		call append(line(".")+23, "		solve();")
		call append(line(".")+24, "	}")
		call append(line(".")+25, "")
		call append(line(".")+26, "	return 0;")
		call append(line(".")+27, "}")
		call append(line(".")+28, "")
		call append(line(".")+29, "void solve(){")
		call append(line(".")+30, "}")
